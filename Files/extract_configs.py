...
import pytz  # برای محاسبه زمان به وقت ایران
...
"""
    # لینک‌های کانفیگ آماده (حذف Iran.yaml و UK.yaml)
...
"""
    for country in sorted(countries_protocols.keys()):
        ...
        if count > 0:
            ...
            country_name = countries_protocols[country][2]  # نام فارسی
